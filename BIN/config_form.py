...
class ConfiguracaoDinamica(QWidget):
    ...
    def __init__(self, codyn_dir, tabs):
        ...
        # --------Tipo de Caixa como ComboBox --------
        self.box_type = QComboBox()
        self.box_type.addItems([
            "cubic",
            "triclinic",
            "dodecahedron",
            "octahedron"
        ...
        form_layout.addRow("Box Type:", self.box_type)
    ...
    def salvar_dados(self):
        try:
            ...
            form_data = {
                ...
                "box_type": self.box_type.currentText(),
            ...
            if len(prot_files) != 1:
                QMessageBox.warning(self, "Attention", "Only one protein can be used in this process at a time. Place only one file in the protein folder.")
                self.tabs.setCurrentIndex(0)
                return
