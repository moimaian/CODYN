...
In this first execution, the virtual Python environment will be created in $HOME/.venv/CODYN, where the program packages that are prerequisites for running CODYN will be installed (see PREREQUISITES).
